...
namespace DatabaseHelper.Postgre
{
    public class PostgreSqlDatabaseHelper : BaseDatabaseHelper
    {
        ...
        protected PostgreSqlDatabaseHelper(NpgsqlConnection connection)
        {
            _connection = connection;
            _disposeConnection = false;
        }

        protected PostgreSqlDatabaseHelper(NpgsqlConnectionStringBuilder connectionBuilder)
        {
            _connection = new NpgsqlConnection(connectionBuilder.ConnectionString);
            _disposeConnection = true;
        }

        protected PostgreSqlDatabaseHelper(string host, ushort port, string username, string password) : this(
